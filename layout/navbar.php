    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.php" data-aos="fade-right" data-aos-duration="1000">
            <img src="assets/images/hornbill.png" alt="" style="width:50px;">
            Hornbill Blog</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0" data-aos="fade-left" data-aos-duration="1000">
              <?php if(isset($_SESSION['user'])): ?>  
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#signUp" data-bs-toggle="offcanvas" aria-controls="staticBackdrop"><?php echo $_SESSION['user']->name ?></a>
                </li>
              <?php else: ?>
                <li class="nav-item">
